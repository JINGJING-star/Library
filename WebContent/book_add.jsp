...
<%@ page import="com.toolbean.BookDB" %>
<%@ page import="com.toolbean.BookTypeDB" %>
<%@ page import="com.valuebean.BookForm" %>
<%@ page import="com.valuebean.BookTypeForm"%>
<%@ page import="com.toolbean.BookCaseDB" %>
<%@ page import="com.valuebean.BookCaseForm" %>
<%@ page import="com.toolbean.PublishingDB" %>
<%@ page import="com.valuebean.PublishingForm" %>
<%@ page import="java.util.*"%>
<html>
<%
	String str=null;
BookTypeDB bookTypeDAO=new BookTypeDB();
...
if(coll_type==null || coll_type.isEmpty()){
	out.println("<script>alert('请先录入图书类型信息!');history.back(-1);</script>");
	  ...
	  int typeID=0;
	  String typename="";
	  BookCaseDB bookcaseDAO=new BookCaseDB();
	  String str1=null;
	  ...
	  if(coll_bookcase==null || coll_bookcase.isEmpty()){
	  	...
	  	int bookcaseID=0;
	  	String bookcasename="";
	  PublishingDB pubDAO=new PublishingDB();
	  String str2=null;
