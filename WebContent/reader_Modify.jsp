...
<%@ page import="com.toolbean.ReaderDB" %>
<%@ page import="com.toolbean.ReaderTypeDB" %>
<%@ page import="com.valuebean.ReaderForm" %>
<%@ page import="com.valuebean.ReaderTypeForm"%>
<%@ page import="java.util.*"%>
<html>
<%
	String str=null;
ReaderTypeDB readerTypeDAO=new ReaderTypeDB();
