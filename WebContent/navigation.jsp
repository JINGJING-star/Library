...
<%@ page import="com.toolbean.ManagerDB"%>
<%@ page import="com.valuebean.ManagerForm"%>
<%
	ManagerDB managerDAO=new ManagerDB();
String user = (String)session.getAttribute("manager");
ManagerForm form1=(ManagerForm)managerDAO.query_p(user);
int sysset1=0;
int readerset1=0;
int bookset1=0;
int borrowback1=0;
...
<table width="778"  border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr bgcolor="#DFA40C">
        ...
        <td width="66%" align="right" bgcolor="#ad7c28" class="word_white"><a href="main.jsp" class="word_white">首页</a> |
        	...
        	<%if(readerset1==1){%><a  onmouseover=showmenu(event,readermenu) onmouseout=delayhidemenu() style="CURSOR:hand"  class="word_white">读者管理</a> | <%}%>
        	...
        	<%if(sysquery1==1){%><a  onmouseover=showmenu(event,querymenu) onmouseout=delayhidemenu()  class="word_white" style="CURSOR:hand" >系统查询</a> | <%}%>
