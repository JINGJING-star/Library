...
return bookForm;
   ...
   BookForm bookForm=null; 
   String sql="select tb_bookinfo.*,tb_bookcase.name,tb_publishing.pubname,tb_booktype.typename "
   		    + "from tb_bookinfo,tb_bookcase,tb_booktype,tb_publishing "
   		    + "where tb_bookinfo.id=tb_bookcase.id and " 
		    +       "tb_bookinfo.id=tb_booktype.id and "
   		    +       "tb_bookinfo.ISBN=tb_publishing.ISBN and " +f+ "='"+key+"'";
