...
import com.valuebean.BorrowForm;
import com.valuebean.ReaderForm;
...
public class BorrowDB {
    ...
    public int insertBorrow(ReaderForm readerForm,BookForm bookForm,String operator){
        ...
        //计算归还时间
          ...
          String sql ="Insert into tb_borrow (readerid,bookid,borrowTime,backTime,operator) values("+readerForm.getId()+","+bookForm.getId()+",'"+date+"','"+date+"','"+operator+"')";
