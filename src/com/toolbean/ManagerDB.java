...
import com.core.*;
import com.valuebean.ManagerForm;
...
public class ManagerDB {
    ...
    public ManagerForm query_p(String str) {
        ...
        String sql = "select tb_manager.*,sysset,readerset,bookset,borrowback,sysquery "
        		   + "from tb_manager,tb_purview "
        		   + "where tb_manager.id=tb_purview.id and tb_manager.name='"+str+"'";
